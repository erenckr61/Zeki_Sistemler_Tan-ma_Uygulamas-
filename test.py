        ...
        for fileName in os.listdir(TEST_IMAGES_DIR):
            ...
            for prediction in sortedPredictions:
                ...
                if onMostLikelyPrediction:
                    ...
                    print("the object appears to be a " + strClassification + ", " + "{0:.2f}".format(scoreAsAPercent) + "% eslesti")
                    # write the result on the image
                    #writeResultOnImage(openCVImage, strClassification + ", " + "{0:.2f}".format(scoreAsAPercent) + "% eslesti")
                    writeResultOnImage(openCVImage,strClassification + ", " + "{0:.2f}".format(scoreAsAPercent) + "% eslesti")
